...
<head>
  ...
  <style>
    ...
    :root{color-scheme:light;font-family:"IBM Plex Sans","Segoe UI",sans-serif;--bg:#f1f1ed;--panel:#f8f8f4;--ink:#181a1b;--muted:#676c6e;--line:#cfd1cc;--soft:#e8e9e4;--primary:#006b73;--primary-hover:#00545b;--primary-weak:#dcebec;--danger:#a33e35;--radius:4px;--control-h:44px}
    html[data-theme="dark"]{color-scheme:dark;--bg:#101315;--panel:#161a1c;--ink:#edf0ed;--muted:#9aa2a3;--line:#33393b;--soft:#1d2224;--primary:#43bac2;--primary-hover:#67cbd1;--primary-weak:#16343a;--danger:#df7a70}
    *{box-sizing:border-box}body{margin:0;min-height:100vh;overflow-x:clip;display:grid;grid-template-rows:56px 1fr;background:var(--bg);color:var(--ink)}
    ...
    .logo{display:grid;place-items:center;width:30px;height:30px;border:1px solid var(--primary);border-radius:var(--radius);background:var(--primary-weak);color:var(--primary);font-family:"IBM Plex Mono",monospace;font-size:13px;font-weight:700}
    ...
    .stage{display:grid;place-items:center;padding:32px 18px}.login{width:min(440px,100%);border:1px solid var(--line);border-radius:var(--radius);background:var(--panel)}
    ...
    label{display:block;margin-bottom:7px;font-size:13px;font-weight:600}.password-wrap{position:relative}.password-wrap input{width:100%;height:var(--control-h);padding:9px 52px 9px 12px;border:1px solid var(--line);border-radius:var(--radius);background:var(--panel);color:var(--ink);font:16px "IBM Plex Sans",sans-serif;outline:none}.password-wrap input:focus{border-color:var(--primary);box-shadow:0 0 0 2px var(--primary-weak)}
    .eye{position:absolute;right:1px;top:1px;display:grid;place-items:center;width:42px;height:42px;border:0;border-left:1px solid var(--line);border-radius:0 var(--radius) var(--radius) 0;background:var(--soft);color:var(--muted);cursor:pointer}.eye:hover{color:var(--primary)}.eye:focus-visible,.submit:focus-visible{outline:2px solid var(--primary);outline-offset:2px}.eye svg{width:19px;height:19px}.eye[aria-pressed="true"]:after{content:"";position:absolute;width:21px;height:2px;transform:rotate(-42deg);border-radius:2px;background:currentColor}
    .submit{width:100%;height:var(--control-h);margin-top:16px;border:1px solid var(--primary);border-radius:var(--radius);background:var(--primary);color:#fff;font:600 14px "IBM Plex Sans",sans-serif;cursor:pointer}.submit:hover{background:var(--primary-hover)}.submit:disabled{cursor:wait;opacity:.7}.hint{display:flex;align-items:center;gap:7px;margin:16px 0 0;color:var(--muted);font-size:12px}.hint-dot{width:7px;height:7px;border-radius:50%;background:var(--primary)}
